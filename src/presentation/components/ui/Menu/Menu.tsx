...
import { MenuProps } from "@/presentation/components/ui/Menu/Menu.types";
import { MenuContext } from "@/presentation/components/ui/Menu/MenuContext";

export default function Menu({ options, selectedOption, onSelect, className = "" }: MenuProps) {
  const [isOpen, setIsOpen] = useState(false);
  const menuRef = useRef<HTMLDivElement | null>(null);
  const { addNew } = useContext(MenuContext)!;
